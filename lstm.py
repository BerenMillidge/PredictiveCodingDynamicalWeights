...
class PC_LSTM(object):
  def __init__(self,input_dim, hidden_dim,output_dim,vocab_size, batch_size, inference_learning_rate,weight_learning_rate, n_inference_steps_train,weight_init=gaussian_init, bias_init=zeros_init,use_embedding=True,dynamical_weight_update=False, update_dilation_factor=None):
...
if __name__ =='__main__':
    ...
    if args.network_type == "pc":
        net = PC_LSTM(input_size, hidden_size,output_size,vocab_size,batch_size,inference_learning_rate,weight_learning_rate,n_inference_steps,use_embedding=False,dynamical_weight_update=args.dynamical_weight_update, update_dilation_factor=args.update_dilation_factor)
